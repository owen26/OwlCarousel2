    ...
    grunt.initConfig({
        ...
        sass: {
            ...
            dist: {
                ...
                files: {
                    "dist/assets/owl.carousel.es6.css":
                        "src/scss/owl.carousel.es6.scss",
        ...
        concat: {
            dist: {
                files: {
                    "dist/owl.carousel.es6.js": "<%= app.src.scripts %>"
                }
            }
        },
        ...
        cssmin: {
            dist: {
                files: {
                    "dist/assets/owl.carousel.es6.min.css":
                        "dist/assets/owl.carousel.es6.css",
        ...
        usebanner: {
            dist: {
                ...
                files: {
                    src: ["dist/owl.carousel.es6.js", "dist/assets/*.css"]
                }
            }
        },
        ...
        uglify: {
            ...
            dist: {
                files: {
                    "dist/owl.carousel.es6.min.js": "dist/owl.carousel.es6.js"
                }
            }
        },
        ...
        compress: {
            zip: {
                options: {
                    archive: "docs/download/owl.carousel.es6.<%= pkg.version %>.zip"
                },
                files: [
                    {
                        expand: true,
                        cwd: "dist/",
                        src: ["**"],
                        dest: "owl.carousel.es6.<%= pkg.version %>"
                    }
                ]
            }
        },
